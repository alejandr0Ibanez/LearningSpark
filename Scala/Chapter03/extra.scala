...
val mnmDF = spark.read.csv(mnmFile)
mnmDF.printSchema()
...
mnmDF.write.format("JSON").save("dbfs:/FileStore/shared_uploads/alejandro.ibanez@bosonit.com/mnmDF_JSON") //JSON

mnmDF.write.format("CSV").save("dbfs:/FileStore/shared_uploads/alejandro.ibanez@bosonit.com/mnmDF_CSV") //CSV

mnmDF.write.format("AVRO").save("dbfs:/FileStore/shared_uploads/alejandro.ibanez@bosonit.com/mnmDF_AVRO") //AVRO
